...
public interface IPlayer {
    ...
    boolean verifyFlag(Bot bot, Bot bot2);

    void returnBase(IFlag flag, Flag position);

    /**
     * Checks if the game has ended, i.e., if the bot reached the enemy flag and take it to the base.
     *
